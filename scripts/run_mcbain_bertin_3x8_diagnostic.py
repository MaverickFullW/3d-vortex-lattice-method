"""McBain/Bertin 3x8 chordwise-refinement diagnostic."""
...
def main():
    ...
    print(f"Bertin 3x8 chordwise-refinement diagnostic (taper_ratio = {result['taper_ratio']})")
    print("Gamma shape (3, 8), C order (k = i * n_span + j):")
